      ...
      <div class="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
          ...
          <div class="mb-12 lg:mb-0 text-center mx-auto">
            ...
            <h6 class="font-medium">No:1012 Çankaya/ANKARA </h6>
          </div>
          <div class="mb-6 md:mb-0 text-center mx-auto">
            ...
            <h6 class="font-medium"> +90 507 368 71 73</h6>
          </div>
          <div class="mb-6 mt-6 md:mt-0 md:mb-0 text-center mx-auto">
          <AiFillMail className='w-8 h-8 text-blue-600 mb-6 mx-auto'/>
             <h6 class="font-medium">  berkcinr@gmail.com </h6>
          </div>
        </div>
